			...
			<div class="col-xl-5 col-lg-6 col-m d-8 col-sm-10 mx-auto form pt-4">
				<form action="registerCustomer" method="post">
					<fieldset class="form-group">
						<legend class="text-uppercase text-muted mb-4">create new customer</legend>
						...
						<input autocomplete="off" class="form-control form-control-lg mb-4" type="text" name="registrationNumber" placeholder="Enter Regiatration Number" />
